...
from eazy_sdk import CSS, Scope, XPath, parse_html
from eazy_sdk.extraction import ExtractionCompileError, ExtractionError
...
def test_offline_html_module_import_does_not_load_zapros_or_http_transports() -> None:
    program = (
        "import sys; from eazy_sdk.extraction import parse_html; "
