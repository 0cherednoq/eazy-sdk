...
from eazy_sdk_accounts.storage.storage import BaseStorageObserver, StorageObserver, StorageOp
...
async def test_operation_runs_before_then_after() -> None:
    spy = _Spy()
    assert isinstance(spy, StorageObserver)
