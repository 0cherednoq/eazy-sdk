"""Built-in storage observers: logging and event recording."""
...
from eazy_sdk_accounts.storage.repository import EventStore
...
class LoggingObserver(BaseStorageObserver):
...
class EventRecordingObserver(BaseStorageObserver):
