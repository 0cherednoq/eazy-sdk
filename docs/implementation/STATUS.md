...
- `CursorPages[T]`, `Pages.cursor(result, *, cursor, items, next_cursor)`; the first page sends
  the field as the request value holds it (`UNSET` omits the parameter), each next page carries
