...
from eazy_sdk.storage.exceptions import AccountLeasedError
from eazy_sdk.storage.services.base import _StorageService
from eazy_sdk.storage.services.restrictions import BAN as _BAN
from eazy_sdk.storage.services.restrictions import FREEZE as _FREEZE
from eazy_sdk.storage.services.verifications import VERIFIED as _VERIFIED
...
class AccountPool[
    ...
    async def lease(self, account: Any) -> AsyncIterator[Any]:
        ...
        Raises :class:`~eazy_sdk.storage.exceptions.AccountLeasedError` if the
